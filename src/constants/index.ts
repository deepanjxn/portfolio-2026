import { LinkItem, FooterInfoData } from "@/types";

export const LOGO_TEXT = "D\u2015S";

export const INTRO_TEXT =
  "Hi, I'm Deepanjan Sen. I design products, direct projects and help companies build design-driven solutions.";
...
export const BOOK_A_CALL_LINK: LinkItem[] = [
  {
    label: "Book a Call",
...
export const VISUAL_LINKS: LinkItem[] = [
  {
    label: "Visual Designs",
    href: "https://www.figma.com/proto/jbpjmOTNRJQD0V0gw7EMmU/My-Works-%3C%3E-Deepanjan-Sen?node-id=92-375&t=JGOQMLVhVp6ubh9m-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=92%3A375",
  },
  {
    label: "Interactions",
    href: "https://dribbble.com/deepanjansen",
  },
];
...
export const CONTACT_LINKS: LinkItem[] = [
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/deepanjxn",
  },
  {
    label: "Twitter",
    href: "https://twitter.com/deepanjxn",
  },
];

export const FOOTER_INFO: FooterInfoData = {
  year: "2026",
